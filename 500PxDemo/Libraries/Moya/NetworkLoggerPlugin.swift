...
//  University
//
//  Created by MECHIN on 7/19/17.
//  Copyright © 2017 MFEC. All rights reserved.
//
...
public final class NetworkLoggerPlugin: PluginType {
    ...
    fileprivate let dateFormatString = ""
    ...
    public init(verbose: Bool = false,
                cURL: Bool = false,
                output: @escaping (_ separator: String, _ terminator: String, _ items: Any...) -> Void = NetworkLoggerPlugin.reversedPrint,
